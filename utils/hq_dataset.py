...
filelistsPath = os.path.join(os.path.dirname(__file__), '..', 'filelists')
with open(filelistsPath + "/avspeech_train.csv", "r") as f:
    reader = csv.reader(f, delimiter="\t")

    for i, line in enumerate(reader):  
        name = filelistsPath + "/movie_" + line[0].split(',')[0] # youtube ID
